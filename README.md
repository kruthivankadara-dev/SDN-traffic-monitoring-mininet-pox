...
The custom controller performs the following operations:
-Detects switch connection using ConnectionUp
-Handles incoming packets using PacketIn
-Floods packets for forwarding
-Installs flow rules for future traffic
-Requests flow statistics every 5 seconds
-Displays packet and byte counters
